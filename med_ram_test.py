...
HOTEL_MAPPING = {
    "AMP": "ANWAR AL MADINAH MOVENPICK ",
    "SAJA": "SAJA MADINAH ",
    "MADEN": "Maden Hotel",
    "AL HARAM": "GRAND MILLENIUM AL HARAM HOTEL",
    "PULLMAN": "PULLMAN ZAMZAM MADINAH",
    "AQEEQ": "AL AQEEQ MADINAH",
    " FRONT": "TAIBA FRONT HOTEL",
    " HARTHIYA": "FRONTEL AL HARITHIA",
    "LEADER": "LEADER AL MUNA KAREEM",
    "KARAM SADA" : "KARAM AL SAADA HOTEL",
    "SAFWAT": "SAFWAT",
    ...
    "BIR": "BIR",
    "HAYA GROUP": "HAYAH AL WAHA HOTEL",
    "SHAZA MUNA": "SHAZA AL MUNAWARAH HOTEL",
    "QADAT": "QADAT",
    "RUA MASSI": "RUA AL MASSI",
    "ROSE HOLIDAY": "ROSE HOLIDAY MADINAH"
}
