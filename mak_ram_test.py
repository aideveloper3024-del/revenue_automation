""" 
Makkah Ramadan Room Availability Bot
...
SPREADSHEET_ID = os.environ.get("MAK_SPREADSHEET_ID", "1atO6DNwGYTBKJyxVvOoN8whSBjbrgr4tgpEWmUzceAM")
...
def main():
    print("=" * 60)
    print("Makkah Ramadan Room Availability Bot")
    print("=" * 60)
